...
|------|-------|----------|-----------|
| [1](week-01/) | Disciplined Vibe Coding | What Is Vibe Coding? | Lecture + Slides + Lab |
| [2](week-02/) | How AI Coding Actually Works | LLMs, Tokens & Context | Lecture + Slides |
| [3](week-03/) | Ship It Week | PRD → Prototype → Deploy | Lecture + Slides + Extras |
| [4](week-04/) | Iteration & Code Review | Context Engineering | Lecture + Slides |
